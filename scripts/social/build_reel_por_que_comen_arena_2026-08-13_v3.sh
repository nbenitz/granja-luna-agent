...
SUBTITLES="media/selected/social-drafts/2026-08-13-reel-por-que-comen-arena-v3.ass"
OUTPUT="media/selected/social-drafts/2026-08-13-reel-por-que-comen-arena-v3.mp4"
RUNTIME_OUTPUT="runtime/state/content-studio/social-drafts/2026-08-13-reel-por-que-comen-arena-v3.mp4"
...
ffmpeg -y -hide_banner -loglevel warning \
  ...
  -filter_complex "
    ...
    [v0123][v4]xfade=transition=fade:duration=0.3:offset=18.4[basev];

    [0:a]atrim=start=0:end=22.7,asetpts=PTS-STARTPTS,highpass=f=80,lowpass=f=12000,afftdn=nr=8:nf=-45,loudnorm=I=-28:LRA=7:TP=-2,afade=t=in:st=0:d=0.25,afade=t=out:st=22.2:d=0.5[aout];
