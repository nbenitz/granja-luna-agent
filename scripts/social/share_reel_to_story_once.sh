...
RESULT="$STATE_DIR/2026-08-08-share-reel-to-story.json"
LAST_MESSAGE="$STATE_DIR/2026-08-08-share-reel-to-story.last.json"
RUN_LOG="$STATE_DIR/2026-08-08-share-reel-to-story.codex.jsonl"
LOCK="$STATE_DIR/2026-08-08-share-reel-to-story.lock"
SCHEMA="$ROOT/scripts/social/share_reel_to_story_result.schema.json"
PROMPT="$ROOT/scripts/social/share_reel_to_story_2026-08-08.prompt.md"
...
# A successful previous run makes this task idempotent.
